...
/**
 * Arrow field writer for _routing metadata stored as UTF-8 using {@link VarCharVector}.
 */
public class RoutingArrowField extends ArrowField {

    /** Creates a new RoutingArrowField. */
    public RoutingArrowField() {}
