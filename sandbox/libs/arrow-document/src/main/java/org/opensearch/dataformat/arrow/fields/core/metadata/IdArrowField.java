...
/**
 * Arrow field writer for document _id metadata stored as binary using {@link VarBinaryVector}.
 */
public class IdArrowField extends ArrowField {

    /** Creates a new IdArrowField. */
    public IdArrowField() {}
