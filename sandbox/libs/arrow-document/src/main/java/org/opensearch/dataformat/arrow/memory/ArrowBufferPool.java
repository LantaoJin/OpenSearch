...
/**
 * Arrow memory allocator pool for columnar ingest operations.
 *
 * <p>Uses the "ingest" pool from the unified {@link ArrowNativeAllocator}.
 * Child allocators are created per {@link org.opensearch.dataformat.arrow.vsr.ManagedVSR} instance,
...
public class ArrowBufferPool implements Closeable {
     ...
     *                        the owning format plugins {@code createComponents}
     */
