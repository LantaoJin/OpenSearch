...
/**
 * Arrow field writer for _ignored metadata stored as UTF-8 using {@link VarCharVector}.
 */
public class IgnoredArrowField extends ArrowField {

    /** Creates a new IgnoredArrowField. */
    public IgnoredArrowField() {}
