...
/**
 * Arrow field writer for date values stored as millisecond timestamps using {@link TimeStampMilliVector}.
 */
public class DateArrowField extends ArrowField {

    /** Creates a new DateArrowField. */
    public DateArrowField() {}
