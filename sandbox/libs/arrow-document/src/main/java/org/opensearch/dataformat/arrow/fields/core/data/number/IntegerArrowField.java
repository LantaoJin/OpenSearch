...
/**
 * Arrow field writer for 32-bit signed integer values using {@link IntVector}.
 */
public class IntegerArrowField extends NumericArrowField {

    /** Creates a new IntegerArrowField. */
    public IntegerArrowField() {}
