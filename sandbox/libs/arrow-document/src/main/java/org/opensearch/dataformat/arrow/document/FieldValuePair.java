 ...
 *
 * <p>Represents a single field entry collected by {@link ArrowDocumentInput} during
 * document indexing. The field type is used to resolve the corresponding Arrow vector
 * type via {@link org.opensearch.dataformat.arrow.fields.ArrowFieldRegistry}, and the value is
