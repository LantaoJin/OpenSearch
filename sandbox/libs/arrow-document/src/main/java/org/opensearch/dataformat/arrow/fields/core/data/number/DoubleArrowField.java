...
/**
 * Arrow field writer for double-precision floating-point values using {@link Float8Vector}.
 */
public class DoubleArrowField extends NumericArrowField {

    /** Creates a new DoubleArrowField. */
    public DoubleArrowField() {}
