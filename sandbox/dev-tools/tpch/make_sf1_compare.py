...
on = {
    "q1":(0.2,0),"q2":(0.7,0),"q3":(1.0,0),"q4":(0.3,0),"q5":(1.4,0),"q6":(0.1,0),
    "q7":(2.8,0),"q8":(0.5,0),"q9":(1.1,0),"q10":(0.8,0),"q11":(2.2,0),"q12":(0.2,0),
    "q13":(0.9,0),"q14":(0.2,0),"q15":(0.2,0),"q16":(2.9,0),"q17":(0.6,0),"q18":(1.5,0),
    "q19":(0.0,1),"q20":(0.3,0),"q21":(3.8,0),"q22":(0.2,0),
}
...
main = {
    ...
    "q13":(3.7,0),"q14":(4.7,0),"q15":(3.2,0),"q16":(6.1,0),"q17":(6.7,0),"q18":(5.5,0),
...
ax.set_title("TPC-H sf=1 — P50 latency by query: MPP feature branch vs. main",
