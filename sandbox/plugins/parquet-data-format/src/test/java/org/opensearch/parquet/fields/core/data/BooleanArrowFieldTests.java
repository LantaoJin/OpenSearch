...
public class BooleanArrowFieldTests extends OpenSearchTestCase {
    ...
    public void testArrowType() {
        BooleanArrowField field = new BooleanArrowField();
    ...
    private ManagedVSR createVSR(BooleanArrowField field) {
