...
public class TextArrowFieldTests extends OpenSearchTestCase {
    ...
    public void testTextFieldArrowType() {
        assertTrue(new TextArrowField().getArrowType() instanceof ArrowType.Utf8);
        assertTrue(new TextArrowField().getFieldType().isNullable());
    }

    public void testTextFieldAddToGroup() {
        TextArrowField field = new TextArrowField();
    ...
    public void testKeywordFieldArrowType() {
        assertTrue(new KeywordArrowField().getArrowType() instanceof ArrowType.Utf8);
    }

    public void testKeywordFieldAddToGroup() {
        KeywordArrowField field = new KeywordArrowField();
    ...
    public void testIpFieldArrowType() {
        assertTrue(new IpArrowField().getArrowType() instanceof ArrowType.Binary);
    }

    public void testIpFieldAddToGroup() throws Exception {
        IpArrowField field = new IpArrowField();
